...
public interface GitlabClient {
    ...
    Flux<HttpResponse<List<GitlabGroup>>> searchGroups(
    ...
    Flux<HttpResponse<List<GitlabGroup>>> groupSubGroups(
    ...
    Flux<HttpResponse<List<GitlabGroup>>> groupDescendants(
            @PathVariable String id,
            @QueryValue(value = "all_available") boolean allAvailable,
            @QueryValue(value = "per_page") int perPage,
            @QueryValue int page
    ...
    Flux<HttpResponse<List<GitlabProject>>> groupProjects(
            @PathVariable String id,
            @QueryValue(value = "all_available") boolean allAvailable,
            @QueryValue(value = "per_page") int perPage,
            @QueryValue int page
